...
public class ClassHierarchies {
    /**
     * A class' class hierarchy is the list starting from the class itself, and
     * searching the parent
     * class until it reaches `Object` class.
     *
     * <p>
     * For example, `StringBuilder` class' class hierarchy is
    ...
    public static final String[] HIERARCHY_OF_LINKEDLIST = {
            "java.util.LinkedList", "java.util.AbstractSequentialList", "java.util.AbstractList",
